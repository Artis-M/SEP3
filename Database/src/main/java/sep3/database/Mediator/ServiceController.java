            ...
            while (running)
            {
               ...
               // System.out.println(requestCommand.getSpecificOrder());
                ...
                else if(requestCommand.getCommand().equals("removeFriend"))
                {
                    ...
                    userDAO.removeFriend(requestCommand.getSpecificOrder(),requestCommand.getVariableUser());
                ...
                else if(requestCommand.getCommand().equals("DELETE-Chatroom")){
                    System.out.println(requestCommand.getSpecificOrder());
                    chatroomDAO.removeChatroom(requestCommand.getSpecificOrder());
                }
            }
        } catch (IOException e)
        {
